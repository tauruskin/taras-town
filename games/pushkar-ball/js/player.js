...
export class Ball {
   ...
   * left, this is a flash and a knockback and the ball stays in play under
   * control; at zero hearts it is the same full relocation a fall causes,
   * back to the level's start rather than a checkpoint.
   *
